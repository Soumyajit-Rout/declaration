...
class DeclarationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ["id","created_at","declaration_date","name","declaration_no","net_weight",
                  ...
                  "transaction_type","trade_type","detail", "assign_user_id", "assign_user_name","items","is_verified"]
...
class DelcarationListSerilaizer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Declaration
        fields = ["id","name","declaration_no","net_weight","measurements","created_at","assign_user_id", "assign_user_name","is_verified"]
